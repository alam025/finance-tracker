...
app = FastAPI(
    ...
    description="Automatically categorised 95% of transactions with ML model trained on 50k labelled entries",
    version="1.0.0"
)
...
@app.get("/")
async def root():
    return {"message": "Personal Finance Tracker API", "status": "running", "version": "1.0.0"}
